...
- The core rule of the subtraction GCD method is this: If a smaller block can perfectly measure a larger block, it must also be able to perfectly measure the leftover piece when you cut the smaller block out of the larger one.
"""
